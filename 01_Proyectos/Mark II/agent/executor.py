...
from core.tools import execute_tool, get_tool
...
def _call_tool(tool: str, parameters: dict, speak: Callable | None) -> str:
    """Execute a tool through the central MARK II registry.

    The old executor had a separate if/elif map. Keeping this routed through
    core.tools prevents planner/executor drift and catches removed tools such
    as cmd_control before they become runtime surprises.
    """
    ...
    return execute_tool(tool, parameters, player=None, speak=speak)
